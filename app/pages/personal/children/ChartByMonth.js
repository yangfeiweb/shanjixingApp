...
export default class ChartByMonth extends Component {
  ...
  componentDidMount() {
    let dates = utility.getCurrMonthDay(utility.getNowDateStr());
        ...
        <View style={chartStyle.content}>
              ...
              <Col style={chartStyle.container}>
                <View style={chartStyle.container}>
                  <View
                    style={[
                      chartStyle.black,
                      { backgroundColor: "#56BDFF", marginRight: 10 * utility.deviceRatio }
                    ]}
                  />
                ...
                <View
                  style={[{ marginLeft: 10 * utility.deviceRatio }, chartStyle.container]}
                >
                  <View
                    style={[
                      chartStyle.black,
                      { backgroundColor: "#FFF553", marginRight: 10 * utility.deviceRatio }
                    ]}
                  />
                  <Text style={chartStyle.text}>
          ...
          <View style={{ height: 350 * utility.deviceRatio }}>
            <View style={{ width: "100%", height: "100%", overflow: "hidden" }}>
              ...
              >
                <VictoryChart
                  width={2500 * utility.deviceRatio}
